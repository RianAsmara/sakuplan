 ...
 *  - Goals (Home + Target tabungan): 6px, fill leluasa, PLUS a 2px white dashed tick on the
 *    fill's right edge. That tick is not decoration — it is what makes a savings bar read
 *    differently from a spending bar at a glance.
